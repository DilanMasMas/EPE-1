...
<section>
    ...
    <article style="position: relative; height: 150px; width: 500px; bottom: 940px; left: 330px; ">
        ...
        <article style="position: relative; left: 200px; top: 30px; color: blue;">
            <h2>
          La novela fue rechazada por varias editoriales hasta que la editorial Bloomsbury se decidió a publicarla. La edición británica salió a la venta el 26 de junio de 1997, Luego fue adaptada a una pelicula.
          <li>- Harry Potter y la piedra filosofal (2001).
        </li>
        <li>
            Y en el año 2002 fue adaptado a un videojuego
        </li></h2>
    </article>
        </article>
    <head></head>
