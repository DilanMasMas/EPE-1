...
<br>
<h1 style="background-color: black; color: white;" align="center" >Información de libros</h1>
...
<section>
    ...
    <article style="position: relative; height: 150px; width: 500px; bottom: 940px; left: 330px; ">
        ...
        <h4> 
            ...
            <li>- El Señor de los Anillos I: La Comunidad del Anillo</li>

            <li>- El Señor de los Anillos II: Las dos Torres</li>

            <li>- El señor de los Anillos III: El retorno del Rey</li>
        </h4>
